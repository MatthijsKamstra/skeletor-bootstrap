...
Main.prototype = {
	init: function() {
		...
		this.document.addEventListener("DOMContentLoaded",function(event) {
			$global.console.log("[SkeletorBootstrap]" + " Dom ready :: build: " + "2020-10-30 12:52:52" + " ");
			_gthis.loadData();
			_gthis.initScroll();
		});
	}
	,loadData: function() {
		...
		req.onData = function(data) {
			try {
				...
				console.log("src/Main.hx:54:",json);
			} catch( _g ) {
				var e = haxe_Exception.caught(_g).unwrap();
				console.log("src/Main.hx:56:",e);
			}
		};
		req.onError = function(error) {
			console.log("src/Main.hx:60:","error: " + error);
		};
		req.onStatus = function(status) {
			console.log("src/Main.hx:63:","status: " + status);
		};
		req.request(true);
	}
	,initScroll: function() {
